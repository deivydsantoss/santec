								...
								<?php if (isset($products_list)) : ?>
									<?php foreach ($products_list as $products) : ?>
										<tr>
											...
											<td><?= $products['id_category']; ?></td>
											<td class="table-action" width="75">
												<a data-bs-toggle="modal" data-bs-target="#editProduct<?= $products['id']; ?>" class="me-2">
													<i class="text-info" data-feather="edit"></i>
												</a>
												<a data-bs-toggle="modal" data-bs-target="#deleteProduct<?= $products['id']; ?>" class="">
										...
										<div class="modal fade" id="editProduct<?= $products['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
											<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
												<div class="modal-content">
													<div class="modal-body">
														<div class="row">
															...
															<div class="col-md-12 mb-3">
																<label for="params_description" class="form-label">Categoria do Produto</label>
																<input type="text" class="form-control" name="category" id="params_name" placeholder="<?= $products['category']; ?>" required>
										...
										<div class="modal fade" id="deleteProduct<?= $products['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
											<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
												<div class="modal-content">
													<div class="modal-header">
														Editar Parâmetro
														...
														<div class="modal-body">
															<div class="row">
																<div class="col-md-12">
																	...
																	<h3>ATENÇÃO</h3>
																	<hr>
																	<p class="text-muted fs-5">Ao deletar o nome do parâmetro, certifique-se que foram feita as devidas analises , pois a modificação tera um impacto no funcionamento do software.</p>
																</div>
															</div>
														</div>
														<div class="modal-footer d-flex justify-content-end">
